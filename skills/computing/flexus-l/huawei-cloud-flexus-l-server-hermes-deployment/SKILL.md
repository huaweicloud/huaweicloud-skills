...
- Huawei Cloud AK/SK credentials with permissions for:
...
```bash
# Deploy Hermes to Flexus L instance
...
```bash
# Query COC script execution result
...
- Store AK/SK in secure environment variables instead of hardcoding
