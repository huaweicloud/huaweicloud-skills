...
Examples:
  ...
  # One-click deploy Hermes to Flexus L Instance
  python scripts/caller.py deploy --ak <your_ak> --sk <your_sk> --name my-hermes --region cn-north-4

  # Configure ModelArts large model on deployed Hermes instance
  ...
  # Configure Feishu bot channel on deployed Hermes instance
  ...
  # Configure WeCom bot channel on deployed Hermes instance
  ...
  python scripts/caller.py query --ak <your_ak> --sk <your_sk> --execute-uuid <execute_uuid>
    ...
    try:
        if args.command == 'query':
            ...
            result = coc_query_execution(args.execute_uuid, args.ak, args.sk)
