...
from huaweicloudsdkecs.v2.model import ShowServerPasswordRequest
...
# 参数
parser = argparse.ArgumentParser(description="查询 ECS 服务器密码")
...
try:
    ...
    print(f"ecs.server_password 查询失败: {e}")
    exit(1)
