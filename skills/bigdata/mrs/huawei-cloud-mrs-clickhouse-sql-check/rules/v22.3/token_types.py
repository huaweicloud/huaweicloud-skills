# -*- coding: utf-8 -*-
"""
ClickHouse 22.3 Lexer Token Types

Source: ClickHouse 22.3 kernel src/Parsers/Lexer.h

This module defines all token types recognized by the ClickHouse 22.3 lexer.
Key characteristics:
...
Differences from 23.3:
- No PipeMark (|) token — 22.3 lexer only has Concatenation (||), not single pipe;
  single | triggers ErrorSinglePipeMark. PipeMark was added in 23.3.
"""
...
class TokenType(Enum):
    """All token types recognized by ClickHouse 22.3 lexer."""
