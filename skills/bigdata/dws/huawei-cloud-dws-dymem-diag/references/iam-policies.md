# IAM Policies - DWS Memory High Diagnosis
...
| dws:metricData:get | Query monitoring metrics | Get MemStat, InstanceMemory, memory_diagnose_detail and other metric data |
