...
配置(环境变量, 均可选):
    ...
    SKILL_QUALITY_AK         华为云 AK (优先 HUAWEI_ACCESS_KEY, 回退 HUAWEICLOUD_SDK_AK / HUAWEI_CLOUD_SDK_AK / HW_ACCESS_KEY)
    SKILL_QUALITY_SK         华为云 SK (优先 HUAWEI_SECRET_KEY, 回退 HUAWEICLOUD_SDK_SK / HUAWEI_CLOUD_SDK_SK / HW_SECRET_KEY)
...
def _read_ak_sk(json_creds=None):
    ...
    """
# ① 环境变量 (与 lib/utils.sh: ensure_ak_sk 的回退链一致:
    #    HUAWEI_ACCESS_KEY / HUAWEI_SECRET_KEY 优先, 其次 SKILL_QUALITY_AK/SK,
    #    再其他 HUAWEI*/HW*/HWC* 变体)
