...
This guide describes how to install and configure Huawei Cloud KooCLI (hcloud) to support all operations of the UCS policy governor skill.
...
If policy definitions are returned, credentials are configured correctly.
