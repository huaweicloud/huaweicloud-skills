...
* Create a `terraform.tfvars` file and fill in the required variables:
  ...
  ```
* Before planning, provide the required `instance_password` through the `TF_VAR_instance_password` environment variable or an approved secret-injection mechanism. Never store it in `terraform.tfvars`.
