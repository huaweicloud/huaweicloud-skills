...
Required for extracting solution info and estimated price from the SAC detail page.
...
Required for deploying the Dify platform with Terraform (`init/plan/apply`).
